...
// HORIZONTAL TIMELINER_________________________
...
(function() {
  ...
  var HorizontalTimeline = function(element) {
		...
		console.log(this.element.getElementsByClassName('h--timeline-dates')[0])
		console.log(this.element.getElementsByClassName('h--timeline-dates'))
...
// SLICK SLIDER______________________________________
...
function goToContact()
{
	...
	setTimeout(goToContactHandler,500);
}
